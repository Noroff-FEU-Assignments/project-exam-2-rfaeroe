...
then use yarn start to run the application in the browser or visit holidaze.byfaeroe.com for a deployed version

### Admin user name and password

To login for admin site, use username admin and password admin1234
